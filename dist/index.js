  ...
  quickSetter: function quickSetter(target, property, unit) {
    ...
    if (target.length > 1) {
      var setters = target.map(function(t3) {
        return gsap2.quickSetter(t3, property, unit);
      }), l5 = setters.length;
      return function(value) {
        var i4 = l5;
        while (i4--) {
...
var _createElement3 = function _createElement4(type, ns) {
  var e4 = _doc4.createElementNS ? _doc4.createElementNS((ns || "http://www.w3.org/1999/xhtml").replace(/^https/, "http"), type) : _doc4.createElement(type);
  return e4.style ? e4 : _doc4.createElement(type);
};
...
var _addScrollListener = function _addScrollListener2(e4, callback) {
  _addListener(e4, "scroll", callback);
...
var _removeScrollListener = function _removeScrollListener2(e4, callback) {
  _removeListener(e4, "scroll", callback);
  if (!_isRoot(e4.parentNode)) {
    _removeScrollListener2(e4.parentNode, callback);
  }
};
var _isRoot = function _isRoot2(e4) {
  return !!(!e4 || e4 === _docElement3 || e4.nodeType === 9 || e4 === _doc4.body || e4 === _win4 || !e4.nodeType || !e4.parentNode);
};
...
var _parseRect = function _parseRect2(e4) {
  if (e4 === _win4) {
    ...
    _tempRect.width = _tempRect.right = _docElement3.clientWidth || e4.innerWidth || _body2.clientWidth || 0;
    _tempRect.height = _tempRect.bottom = (e4.innerHeight || 0) - 20 < _docElement3.clientHeight ? _docElement3.clientHeight : e4.innerHeight || _body2.clientHeight || 0;
    return _tempRect;
  }
  var doc = e4.ownerDocument || _doc4, r6 = !_isUndefined3(e4.pageX) ? {
  ...
  } : !e4.nodeType && !_isUndefined3(e4.left) && !_isUndefined3(e4.top) ? e4 : _toArray(e4)[0].getBoundingClientRect();
...
var _getBounds = function _getBounds2(target, context3) {
  var e4 = _toArray(target)[0], top, left, offset;
  if (!e4.nodeType && e4 !== _win4) {
...
var Draggable = /* @__PURE__ */ function(_EventDispatcher) {
  ...
  function Draggable2(target, vars) {
    ...
    var type = (vars.type || "x,y").toLowerCase(), xyMode = ~type.indexOf("x") || ~type.indexOf("y"), rotationMode = type.indexOf("rotation") !== -1, xProp = rotationMode ? "rotation" : xyMode ? "x" : "left", yProp = xyMode ? "y" : "top", allowX = !!(~type.indexOf("x") || ~type.indexOf("left") || type === "scroll"), allowY = !!(~type.indexOf("y") || ~type.indexOf("top") || type === "scroll"), minimumMovement = vars.minimumMovement || 2, self = _assertThisInitialized2(_this2), triggers = _toArray(vars.trigger || vars.handle || target), killProps = {}, dragEndTime = 0, checkAutoScrollBounds = false, autoScrollMarginTop = vars.autoScrollMarginTop || 40, autoScrollMarginRight = vars.autoScrollMarginRight || 40, autoScrollMarginBottom = vars.autoScrollMarginBottom || 40, autoScrollMarginLeft = vars.autoScrollMarginLeft || 40, isClickable = vars.clickableTest || _isClickable, clickTime = 0, gsCache = target._gsap || gsap3.core.getCache(target), isFixed = _isFixed3(target), getPropAsNum = function getPropAsNum2(property, unit) {
      ...
      var i4;
      if (!enabled || self.isPressed || !e4 || (e4.type === "mousedown" || e4.type === "pointerdown") && !force && _getTime() - clickTime < 30 && _touchEventLookup[self.pointerEvent.type]) {
      ...
      if (!_supportsPointer || !touchEventTarget) {
        ...
        e4 && e4.target && _addListener(e4.target, "mouseup", onRelease);
      }
      isClicking = isClickable.call(self, e4.target) && vars.dragClickables === false && !force;
      if (isClicking) {
        _addListener(e4.target, "change", onRelease);
      ...
      var originalEvent = e4, wasDragging = self.isDragging, isContextMenuRelease = self.vars.allowContextMenu && e4 && (e4.ctrlKey || e4.which > 2), placeholderDelayedCall = gsap3.delayedCall(1e-3, removePlaceholder), touches, i4, syntheticEvent, eventTarget, syntheticClick;
      if (touchEventTarget) {
      ...
      if (!_supportsPointer || !touchEventTarget) {
        ...
        e4 && e4.target && _removeListener(e4.target, "mouseup", onRelease2);
      }
      dirty = false;
      if (wasDragging) {
      ...
      if (isClicking && !isContextMenuRelease) {
        if (e4) {
          _removeListener(e4.target, "change", onRelease2);
      ...
      var time = _getTime(), recentlyClicked = time - clickTime < 100, recentlyDragged = time - dragEndTime < 50, alreadyDispatched = recentlyClicked && clickDispatch === clickTime, defaultPrevented = self.pointerEvent && self.pointerEvent.defaultPrevented, alreadyDispatchedTrusted = recentlyClicked && trustedClickDispatch === clickTime, trusted = e4.isTrusted || e4.isTrusted == null && recentlyClicked && alreadyDispatched;
    ...
    _this2.getDirection = function(from, diagonalThreshold) {
      var mode = from === "velocity" && InertiaPlugin ? from : _isObject3(from) && !rotationMode ? "element" : "start", xChange, yChange, ratio, direction, r1, r22;
      if (mode === "element") {
...
var _getTarget = function _getTarget2(t3, self) {
  return (self && self._ctx && self._ctx.selector || gsap4.utils.toArray)(t3)[0] || (typeof t3 === "string" && gsap4.config().nullTargetWarn !== false ? console.warn("Element not found:", t3) : null);
};
...
var _getScrollFunc = function _getScrollFunc2(element, _ref) {
  ...
  _scrollers[i4 + offset] || _addListener3(element, "scroll", _onScroll);
...
var _getVelocityProp = function _getVelocityProp2(value, minTimeRefresh, useDelta) {
  var v1 = value, v2 = value, t1 = _getTime2(), t22 = t1, min = minTimeRefresh || 50, dropToZeroTime = Math.max(500, min * 3), update2 = function update3(value2, force) {
    var t3 = _getTime2();
    if (force || t3 - t1 > min) {
      v2 = v1;
      v1 = value2;
    ...
    var tOld = t22, vOld = v2, t3 = _getTime2();
...
var Observer = /* @__PURE__ */ function() {
  ...
  _proto.init = function init5(vars) {
    ...
    var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self = this, prevDeltaX = 0, prevDeltaY = 0, passive = vars.passive || !preventDefault && vars.passive !== false, scrollFuncX = _getScrollFunc(target, _horizontal), scrollFuncY = _getScrollFunc(target, _vertical), scrollX = scrollFuncX(), scrollY = scrollFuncY(), limitToTouch = ~type.indexOf("touch") && !~type.indexOf("pointer") && _eventTypes[0] === "pointerdown", isViewport = _isViewport(target), ownerDoc = target.ownerDocument || _doc5, deltaX = [0, 0, 0], deltaY = [0, 0, 0], onClickTime = 0, clickCapture = function clickCapture2() {
      ...
      if (!isDragNotClick && isTrackingDrag) {
        ...
        if (preventDefault && allowClicks) {
          gsap4.delayedCall(0.08, function() {
            if (_getTime2() - onClickTime > 300 && !e4.defaultPrevented) {
              if (e4.target.click) {
                e4.target.click();
              } else if (ownerDoc.createEvent) {
      ...
      var multiplier = (e4.deltaMode === 1 ? lineHeight : e4.deltaMode === 2 ? _win5.innerHeight : 1) * wheelSpeed;
...
var _maxScroll = function _maxScroll2(element, _ref2) {
  ...
  return Math.max(0, (s5 = "scroll" + d2) && (a4 = _getProxyProp(element, s5)) ? a4() - _getBoundsFunc(element)()[d3] : _isViewport3(element) ? (_docEl2[s5] || _body4[s5]) - _getViewportDimension(d2) : element[s5] - element["offset" + d2]);
};
...
var _getBounds3 = function _getBounds4(element, withoutTransforms) {
  var tween = withoutTransforms && _getComputedStyle3(element)[_transformProp4] !== "matrix(1, 0, 0, 1, 0, 0)" && gsap5.to(element, {
    x: 0,
    y: 0,
    xPercent: 0,
    yPercent: 0,
...
var _snapDirectional = function _snapDirectional2(snapIncrementOrArray) {
  var snap3 = gsap5.utils.snap(snapIncrementOrArray), a4 = Array.isArray(snapIncrementOrArray) && snapIncrementOrArray.slice(0).sort(function(a5, b2) {
    return a5 - b2;
  });
...
var _createMarker = function _createMarker2(type, name, container, direction, _ref4, offset, matchWidthEl, containerAnimation) {
  ...
  var e4 = _doc6.createElement("div"), useFixedPosition = _isViewport3(container) || _getProxyProp(container, "pinType") === "fixed", isScroller = type.indexOf("scroller") !== -1, parent = useFixedPosition ? _body4 : container, isStart = type.indexOf("start") !== -1, color = isStart ? startColor : endColor, css = "border-color:" + color + ";font-size:" + fontSize + ";color:" + color + ";font-weight:" + fontWeight + ";pointer-events:none;white-space:nowrap;font-family:sans-serif,Arial;z-index:1000;padding:4px 8px;border-width:0;border-style:solid;";
...
var _refreshAll = function _refreshAll2(force, skipRevert) {
  ...
  _updateAll(2);
  _triggers.forEach(function(t3) {
    return _isFunction5(t3.vars.onRefresh) && t3.vars.onRefresh(t3);
  });
...
var _updateAll = function _updateAll2(force) {
  if (force === 2 || !_refreshingAll && !_isReverted) {
    ...
    var l5 = _triggers.length, time = _getTime3(), recordVelocity = time - _time1 >= 50, scroll = l5 && _triggers[0].scroll();
...
var ScrollTrigger2 = /* @__PURE__ */ function() {
  ...
  _proto.init = function init5(vars, animation) {
    ...
    if (snap3) {
      ...
      _scrollers.forEach(function(o6) {
        return _isFunction5(o6) && o6.target === (isViewport ? _doc6.scrollingElement || _docEl2 : scroller) && (o6.smooth = false);
      });
      ...
      snapDelayedCall = gsap5.delayedCall(snap3.delay || scrubSmooth / 2 || 0.1, function() {
        ...
        if ((refreshedRecently || Math.abs(self.getVelocity()) < 10) && !tween && !_pointerIsDown && lastSnap !== scroll) {
          var progress = (scroll - start) / change, totalProgress = animation && !isToggle ? animation.totalProgress() : progress, velocity = refreshedRecently ? 0 : (totalProgress - snap22) / (_getTime3() - _time2) * 1e3 || 0, change1 = gsap5.utils.clamp(-progress, 1 - progress, _abs(velocity / 2) * velocity / 0.185), naturalEnd = progress + (snap3.inertia === false ? 0 : change1), endValue, endScroll, _snap = snap3, onStart = _snap.onStart, _onInterrupt = _snap.onInterrupt, _onComplete = _snap.onComplete;
    ...
    self.refresh = function(soft, force, position, pinOffset) {
      ...
      var size = getScrollerSize(), scrollerBounds = getScrollerOffsets(), max = containerAnimation ? containerAnimation.duration() : _maxScroll(scroller, direction), isFirstRefresh = change <= 0.01 || !change, offset2 = 0, otherPinOffset = pinOffset || 0, parsedEnd = _isObject5(position) ? position.end : vars.end, parsedEndTrigger = vars.endTrigger || trigger, parsedStart = _isObject5(position) ? position.start : vars.start || (vars.start === 0 || !trigger ? 0 : pin ? "0 0" : "0 100%"), pinnedContainer = self.pinnedContainer = vars.pinnedContainer && _getTarget(vars.pinnedContainer, self), triggerIndex = trigger && Math.max(0, _triggers.indexOf(self)) || 0, i4 = triggerIndex, cs2, bounds, scroll, isVertical, override, curTrigger, curPin, oppositeScroll, initted, revertedPins, forcedOverflow, markerStartOffset, markerEndOffset;
    ...
    self.update = function(reset, recordVelocity, forceFake) {
      ...
      if (clipped !== prevProgress2 && self.enabled) {
        ...
        preventOverlaps && (toggled || isTakingAction) && (isTakingAction || scrub || !animation) && (_isFunction5(preventOverlaps) ? preventOverlaps(self) : self.getTrailing(preventOverlaps).forEach(function(t3) {
  ...
  ScrollTrigger3.disable = function disable(reset, kill) {
    ...
    for (var i4 = 0; i4 < _scrollers.length; i4 += 3) {
      _wheelListener(_removeListener5, _scrollers[i4], _scrollers[i4 + 1]);
      _wheelListener(_removeListener5, _scrollers[i4], _scrollers[i4 + 2]);
    }
  };
  ScrollTrigger3.enable = function enable() {
    ...
    if (gsap5) {
      ...
      if (_body4) {
        ...
        var bodyHasStyle = _body4.hasAttribute("style"), bodyStyle = _body4.style, border = bodyStyle.borderTopStyle, AnimationProto = gsap5.core.Animation.prototype, bounds, i4;
        ...
        _transformProp4 = gsap5.utils.checkPrefix("transform");
  ...
  ScrollTrigger3.scrollerProxy = function scrollerProxy(target, vars) {
    ...
    if (vars) {
      isViewport ? _proxies.unshift(_win6, vars, _body4, vars, _docEl2, vars) : _proxies.unshift(t3, vars);
    }
  };
...
ScrollTrigger2.batch = function(targets, vars) {
  var result = [], varsCopy = {}, interval = vars.interval || 0.016, batchMax = vars.batchMax || 1e9, proxyCallback = function proxyCallback2(type, callback) {
    var elements2 = [], triggers = [], delay = gsap5.delayedCall(interval, function() {
...
var _nestedScroll = function _nestedScroll2(_ref5) {
  ...
  var node = (event2.changedTouches ? event2.changedTouches[0] : event2).target, cache = node._gsap || gsap5.core.getCache(node), time = _getTime3(), cs;
...
ScrollTrigger2.sort = function(func) {
  ...
  ScrollTrigger2.getAll().forEach(function(t3) {
    return t3._sortY = t3.trigger ? scroll + t3.trigger.getBoundingClientRect().top : t3.start + _win6.innerHeight;
  });
...
var _SplitText = class _SplitText2 {
  ...
  static register(core) {
    ...
    if (gsap6) {
      ...
      _context5 = gsap6.core.context || _context5;
    }
...
var visibleMarmottes = /* @__PURE__ */ new Set();
...
var namespaceContexts = /* @__PURE__ */ new Map();
...
var isContext = (v) => typeof v === "object" && v !== null && typeof v.revert === "function";
var runNamespaceRun = () => {
  const ns = getNamespace();
  if (!ns) return;
...
function initBeforeAfter() {
  ...
  wrappers.forEach((wrapper) => {
    ...
    const instances3 = Draggable.create(dragger, {
      ...
      bounds: wrapper,
      onDrag() {
        const x2 = wrapper.offsetWidth / 2 - gsap.getProperty(this.target, "x");
        gsap.set(afterImgWrap, { clipPath: `inset(0 calc(${x2}px - 0.125rem) 0 0)` });
      }
    });
...
var initFooterLoop = () => {
  const containers = document.querySelectorAll(".footer_collection-list");
  containers.forEach((container) => {
    ...
    const items = Array.from(container.querySelectorAll(".footer_collection-item"));
    ...
    const allItems = Array.from(container.querySelectorAll(".footer_collection-item"));
    requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        ...
        const handleMouseEnter = () => {
          if (isHovering) return;
          isHovering = true;
          gsapWithCSS.to(tl, { timeScale: 0, duration: 0.3, ease: "power2.out", overwrite: true });
        };
        const handleMouseLeave = () => {
          if (!isHovering) return;
          isHovering = false;
          gsapWithCSS.to(tl, { timeScale: 1, duration: 0.3, ease: "power2.out", overwrite: true });
        };
...
var cleanups2 = /* @__PURE__ */ new Set();
var animatedTargets = /* @__PURE__ */ new Set();
function initSocialShare() {
  ...
  linkButtons.forEach((button) => {
    ...
    if (!copyText) return;
    gsapWithCSS.set(copyText, { opacity: 0, yPercent: 200 });
    ...
    cleanups2.add(() => button.removeEventListener("click", onClick2));
  });
}
function destroySocialShare() {
  cleanups2.forEach((fn) => fn());
  cleanups2.clear();
  animatedTargets.forEach((el) => gsapWithCSS.killTweensOf(el));
...
function destroyClientLoop() {
  activeContainers.forEach((container) => {
    ...
    container.querySelectorAll('[data-cloned="true"]').forEach((clone) => {
      clone.remove();
    });
  });
  activeContainers = [];
...
var killSunHeroParallax = () => {
  ...
  suns.forEach((sun) => {
    gsapWithCSS.set(sun, { willChange: "auto" });
  });
};
...
var setupGlobalHeroInitialState = () => {
...
// src/index.ts
gsapWithCSS.registerPlugin(ScrollTrigger2, Draggable, SplitText);
